        ...
        >
            ...
            <div className="container mx-auto px-6 lg:px-16 relative z-10">
                <div className="flex flex-col lg:flex-row items-center justify-between gap-16">
                    ...
                    {/* ════ LEFT: Content ════ */}
                    <div className="flex gap-8 md:gap-12 items-start w-full lg:w-auto">
                        {/* Side Info Bar */}
                        <motion.div
                        ...
                        <div className="flex-1">
                            ...
                            >
                                ...
                                <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl xl:text-8xl font-heading font-black text-text-primary leading-[0.9] mb-6 tracking-tight">
                                    Akash
                            ...
                            <motion.div
                                ...
                                className="text-xl md:text-2xl lg:text-3xl font-heading font-semibold text-text-primary mb-6"
                            >
                                <Typewriter
                                    options={{
                            ...
                            <motion.p
                                ...
                                className="text-text-secondary text-lg max-w-md mb-10 leading-relaxed border-l-2 border-accent/20 pl-6"
                            >
                            ...
                            >
                                <a href={resumeFilePath} download className="btn-primary px-10 py-4 rounded-none font-bold skew-x-[-12deg] hover:skew-x-0 transition-all">
                                    <span className="skew-x-[12deg] inline-block flex items-center gap-2">
                                        <FaDownload size={14} /> DOWNLOAD CV
                                    </span>
                                </a>
                                <Link to="contact" smooth={true} className="btn-outline px-10 py-4 rounded-none cursor-pointer skew-x-[-12deg] hover:skew-x-0 transition-all group">
                    ...
                    {/* ════ RIGHT: Avatar & Multi-Floating Stats ════ */}
                    <motion.div
                        initial={{ opacity: 0, scale: 0.8 }}
                        animate={{ opacity: 1, scale: 1 }}
                        transition={{ duration: 1 }}
                        className="relative w-full lg:w-[50%] flex justify-center py-20 lg:py-0"
                    >
                        {/* Glow Background */}
                        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[100%] h-[100%] bg-accent/10 rounded-full blur-[120px] pointer-events-none" />
                        ...
                        <div className="relative">
                            ...
                            <img
                                src={heroAvatar}
                                alt="Akash B"
                                className="w-[280px] md:w-[300px] lg:w-[300px] relative z-20 object-contain drop-shadow-[0_10px_30px_rgba(0,0,0,0.5)]"
                            />
                            ...
                            <motion.div
                                ...
                                className="absolute top-8 md:top-12 right-0 md:-right-8 z-30 bg-primary/60 border border-accent/40 p-2 md:p-4 backdrop-blur-md shadow-2xl cursor-default flex flex-col justify-center"
                            >
                                <div className="absolute top-0 right-0 w-2 h-2 border-t border-r border-accent" />
                                <p className="text-accent font-black text-2xl md:text-3xl italic leading-none">03+</p>
                                <p className="text-[8px] md:text-[9px] uppercase font-mono tracking-widest text-text-secondary">Projects Done</p>
                            </motion.div>
                            ...
                            <motion.div
                                ...
                                whileHover={{ scale: 1.1 }}
                                className="absolute bottom-10 right-0 md:-right-12 z-30 bg-primary/60 border border-white/5 p-2 md:p-4 backdrop-blur-md shadow-2xl flex items-center gap-2 md:gap-3"
                            >
                                <div className="p-2 bg-white/5 text-accent rounded-full border border-white/10">
                                    <FaAward size={18} />
                                </div>
                                <div>
                                    <p className="text-white text-[10px] font-bold leading-none">Learning</p>
                                    <p className="text-text-secondary text-[8px] font-mono">Continuous Growth</p>
                                </div>
                            </motion.div>

                            {/* STAT 4: Commits/Activity (Bottom Left) */}
                            <motion.div
                                animate={{ y: [0, 20, 0], rotate: [0, -3, 0] }}
                                transition={{ repeat: Infinity, duration: 4.5, ease: "easeInOut", delay: 1.2 }}
                                whileHover={{ scale: 1.1 }}
                                className="absolute -bottom-4 left-0 md:left-0 z-30 bg-accent p-2 md:p-3 shadow-[0_10px_30px_rgba(240,192,64,0.3)] flex items-center gap-2"
                            >
                                <FaCodeBranch className="text-primary" size={14} />
                                <span className="text-primary font-black text-xs uppercase tracking-tighter italic">Weekly Commits++</span>
                            </motion.div>
                        </div>
                    </motion.div>
                </div>
